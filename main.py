...
# 登录后立刻显示新手提示
       st.markdown(
    """
    <div style="font-size:1.3em; background:#333333; color:#ffffff; border-radius:12px; padding:18px 20px; margin-bottom:18px; border:2px solid #555555; display:flex; align-items:center; gap:12px;">
...
# 主界面
    ...
    with st.sidebar.expander("📖 使用教程", expanded=False):
        ...
        <h4>1. 创建新项目</h4>
        <ul>
            <li>请右上角三点->setting->dark保证界面美观</li>
            <li>点击侧边栏的"➕ 创建新项目"</li>
        ...
        <h4>2. 上传内容</h4>
        <ul>
            <li>在"📤 内容上传"标签页中（文件名保证不含汉字，否则axioserror）：</li>
            <li>上传题目图片或文档</li>
            <li>上传标准答案</li>
